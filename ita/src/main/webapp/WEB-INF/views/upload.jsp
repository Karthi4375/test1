...
<body>
	...
	<div class="ita_form">
		...
		<form:form action="${addAction2003}" method="post"
			enctype="multipart/form-data" commandName="bean">
			...
			<a href="/ita/user">View Users</a>
			<a href="/ita/add">Add Users</a>
			<a href="/ita/search">search</a>

		</form:form>

		<form:form action="${addAction2007}" method="post"
			enctype="multipart/form-data" commandName="bean">
			<div class="panel panel-default">
				<div class="panel-heading">
